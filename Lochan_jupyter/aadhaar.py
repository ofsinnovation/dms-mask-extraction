...
class AadhaarDataset(utils.Dataset):
    ...
    def load_aadhaar(self, dataset_dir, subset):
        ...
        self.add_class("chola", 1, "aadhar_full_front")
        self.add_class("chola", 2, "aadhar_full_back")
        self.add_class("chola", 3, "aadhar_half_front")
        self.add_class("chola", 4, "aadhar_half_back")
