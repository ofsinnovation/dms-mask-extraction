# Flask file for  aadhar-document-extractor
...
class InferenceConfig(Config):
    ...
    NUM_CLASSES = 1+2  # Background + [pan_front]
    ...
    CLASS_MAPPING = {"aadhar_half_front":1, "aadhar_half_back":2}
    # for Cloud
    DEFAULT_LOG_FILE = '/home/ofsdms/logs'
    DEFAULT_WEIGHT_FILE_PATH = '/home/ofsdms/aadhaar_document_extraction_30.h5'
     
    # For aadhaar_object_extraction
    DEFAULT_API_NAME = '/aadhaar_document_extraction'
