...
class InferenceConfig(Config):
    ...
    CLASS_MAPPING = {"text": 1}
    # for Cloud
    DEFAULT_LOG_FILE = '/home/ofsdms/logs'
    DEFAULT_WEIGHT_FILE_PATH = '/home/ofsdms/pan_text_strip_extraction_40.h5'
...
def get_detections():
    print(" getting in to strip extration for pan vinsent ")
    ...
    print("getting into strip extraction") 
